            ...
            <div key={item.id} style={styles.cardWrap}>
              ...
              {isOpen && (
                <div style={styles.expanded}>
                  {feedbackLoading && <div style={styles.expandedNote}>Loading feedback...</div>}
                  {feedbackError && <div style={styles.expandedNote}>{feedbackError}</div>}
                            ...
                            return (
                              <div key={domain} style={styles.domainCard}>
                                ...
                                <div style={styles.scoreBarContainer}>
                                  <div style={{ ...styles.scoreBarFill, width: `${(value / 10) * 100}%`, backgroundColor: barColor }} />
                                </div>
...
const styles = {
  ...
  subtitle: { fontSize: '14px', color: '#64748b', margin: '0 0 32px 0' },
  error: {
    backgroundColor: '#450a0a', color: '#fecaca', padding: '12px',
    borderRadius: '6px', marginBottom: '24px', fontSize: '14px',
  },
  emptyState: {
    backgroundColor: '#13131f', border: '1px solid #1e1e35', borderRadius: '12px',
    padding: '40px 24px', textAlign: 'center',
    display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px',
  },
  emptyText: { fontSize: '15px', color: '#94a3b8', lineHeight: '1.6', margin: 0, maxWidth: '460px' },
  spinner: {
  ...
  cardOpen: { borderBottomLeftRadius: '0px', borderBottomRightRadius: '0px', borderColor: '#6366f1' },
  cardLeft: { display: 'flex', flexDirection: 'column', gap: '6px', minWidth: 0 },
  jobTitle: { fontSize: '17px', fontWeight: '600', color: '#f1f5f9' },
  date: { fontSize: '13px', color: '#64748b' },
  improved: { fontSize: '13px', fontWeight: '600', color: '#10b981' },
  cardRight: { display: 'flex', alignItems: 'center', gap: '16px', flexShrink: 0 },
  scoreCircle: {
    width: '64px', height: '64px', borderRadius: '50%', border: '3px solid #6366f1',
    backgroundColor: '#0f0f1a', display: 'flex', flexDirection: 'column',
    alignItems: 'center', justifyContent: 'center',
  },
  scoreValue: { fontSize: '18px', fontWeight: '700', color: '#6366f1', lineHeight: 1 },
  scoreMax: { fontSize: '10px', color: '#64748b', marginTop: '2px' },
  readinessBadge: { padding: '6px 14px', borderRadius: '16px', fontSize: '13px', fontWeight: '600', whiteSpace: 'nowrap' },
  inProgress: { fontSize: '13px', color: '#64748b', fontStyle: 'italic' },
  practiceAgainBtn: {
    padding: '6px 14px', borderRadius: '6px', border: '1px solid #6366f1',
    backgroundColor: 'transparent', color: '#6366f1', fontSize: '12px',
    cursor: 'pointer', fontWeight: '500',
  },
  chevron: { color: '#475569', fontSize: '14px' },
  expanded: {
    backgroundColor: '#0f0f1a', border: '1px solid #6366f1', borderTop: 'none',
    borderBottomLeftRadius: '12px', borderBottomRightRadius: '12px', padding: '24px',
  },
  expandedNote: { fontSize: '14px', color: '#94a3b8', fontStyle: 'italic' },
  block: { marginBottom: '28px' },
  blockTitle: { fontSize: '16px', fontWeight: '600', color: '#f1f5f9', margin: '0 0 14px 0' },
  summaryText: { fontSize: '15px', lineHeight: '1.7', color: '#d1d5db', margin: 0 },
  domainCard: {
    backgroundColor: '#13131f', borderRadius: '12px', padding: '20px',
    marginBottom: '12px', border: '1px solid #1e1e35',
  },
  domainHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' },
  domainName: { fontSize: '16px', fontWeight: '600' },
  domainScore: { fontSize: '15px', fontWeight: '600', color: '#6366f1' },
  scoreBarContainer: {
    width: '100%', height: '8px', backgroundColor: '#1e1e35',
    borderRadius: '4px', overflow: 'hidden', marginBottom: '14px',
  },
  scoreBarFill: { height: '100%', transition: 'width 0.3s ease' },
  reasoning: { fontSize: '14px', color: '#64748b', lineHeight: '1.6', marginBottom: '14px' },
  domainDetails: { display: 'flex', flexDirection: 'column', gap: '10px' },
  detailItem: { display: 'flex', flexDirection: 'column', gap: '4px' },
  detailLabel: { fontSize: '12px', fontWeight: '600', color: '#6366f1', textTransform: 'uppercase' },
  detailText: { fontSize: '14px', color: '#d1d5db', lineHeight: '1.5', margin: 0 },
  highlightsSection: {
    marginTop: '12px', padding: '12px', backgroundColor: '#0f0f1a',
    borderRadius: '8px', border: '1px solid #1e1e35',
  },
  highlightItem: {
    display: 'flex', gap: '8px', alignItems: 'flex-start',
    marginTop: '6px', fontSize: '13px', color: '#94a3b8', lineHeight: '1.5',
  },
  highlightDot: { color: '#6366f1', fontSize: '10px', flexShrink: 0, marginTop: '3px' },
  coachingSection: { display: 'grid', gridTemplateColumns: '1fr', gap: '16px', marginBottom: '28px' },
  coachingColumn: { backgroundColor: '#13131f', borderRadius: '12px', padding: '20px', border: '1px solid #1e1e35' },
  bulletPoint: { display: 'flex', gap: '12px', alignItems: 'flex-start', marginBottom: '10px', fontSize: '14px', color: '#bbf7d0', lineHeight: '1.5' },
  bulletIcon: { color: '#10b981', fontWeight: '700', flexShrink: 0 },
  bulletPointOrange: { display: 'flex', gap: '12px', alignItems: 'flex-start', marginBottom: '10px', fontSize: '14px', color: '#fed7aa', lineHeight: '1.5' },
  bulletIconOrange: { color: '#f59e0b', fontWeight: '700', flexShrink: 0 },
  tipItem: { display: 'flex', gap: '12px', alignItems: 'flex-start', marginBottom: '14px', fontSize: '14px', color: '#d1d5db', lineHeight: '1.5' },
};